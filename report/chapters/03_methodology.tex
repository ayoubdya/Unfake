...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/System Component Architecture.png}
    \caption{System Component Architecture showing the three-tier structure of the UnFake system.}
    \label{fig:system_architecture}
\end{figure}

Figure~\ref{fig:model_selection} illustrates the model selection logic, showing how the system routes input to the appropriate model based on content type.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Model Selection Logic.png}
    \caption{Model selection logic showing how inputs are routed to the appropriate model based on content type.}
    \label{fig:model_selection}
\end{figure}

Figure~\ref{fig:training_architecture} provides an overview of the complete training pipeline, from data sources through processing to the final model artifacts.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Training Architecture Overview.png}
    \caption{Training architecture overview showing data sources, processing steps, and output artifacts.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Headline Model Dataset Label Mapping.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Article Model Multi-Model Evaluation.png}
...
Figure~\ref{fig:backend_api} shows the high-level API processing pipeline from client request to JSON response.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Backend API.png}
    \caption{Backend API processing pipeline showing request validation, preprocessing, inference, and response generation.}
    \label{fig:backend_api}
\end{figure}

Figure~\ref{fig:request_flow} shows the detailed request/response flow through the API.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/RequestResponse Flow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Frontend Screenshot Input Statement.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/Frontend Screenshot Statement Result.png}
