...
\begin{table}[!ht]
    ...
    \begin{tabular}{p{8cm}cc}
        ...
        \midrule
        With voting machines, "They say we're going to have the results in two weeks. With paper ballots, you have the results that night." & Fake & 97\% \\
        Trump says "The unemployment rate for Wisconsin workers has reached historic lows. It’s never been this low before, ever, ever, ever." & Real & 75\% \\
        Washington, D.C., has 41 homicides per 100,000 people, "No. 1 that we can find anywhere in the world." & Fake & 99\% \\
        "Murders this year have spiked 27\% in Philadelphia." & True & 80\% \\
        \bottomrule
    \end{tabular}
\end{table}
